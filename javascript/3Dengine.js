...
const lights = new THREE.PointLight( 0xff0000, 70, 100 );
lights.position.set( 50, 50, 50 );
scene.add( lights );

const lightsY = new THREE.PointLight( 0xEEE62C, 100, 50 );
lightsY.position.set( 100, 45, 50 );
scene.add( lightsY );

const lightb = new THREE.PointLight( 0x338ECF, 100, 30 );
lightb.position.set( 5,  50,  50 );
scene.add( lightb );

var lightAmb = new THREE.AmbientLight(0x777777, 3, 100);
scene.add(lightAmb);
